...
endif; // wordfes2017_setup

add_action( 'after_setup_theme', 'wordfes2017_setup' );
 ...
 */
function wordfes2017_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wordfes2017_content_width', 1000 );
}

add_action( 'after_setup_theme', 'wordfes2017_content_width', 0 );


/**
 * Enqueue scripts and styles.
 */
function wordfes2017_scripts() {
	wp_enqueue_style( 'wfn2017-style', get_stylesheet_uri() );

	// bootstrap
	wp_enqueue_style( 'wfn2017-bootstrap', get_template_directory_uri().'/bootstrap/css/bootstrap.min.css' );
	wp_enqueue_style( 'wfn2017-awesome', '//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css' );
	...
	if( is_front_page() ) {
		...
		wp_enqueue_style( 'wfn2017-home', get_template_directory_uri() . '/css/home.css' );
		
	} elseif ( is_page('test') ) {
		
		wp_enqueue_style( 'wfn2017-home', get_template_directory_uri() . '/css/home.css' );
		wp_enqueue_style( 'wfn2017-test', get_template_directory_uri() . '/css/test.css' );
		
	} elseif ( is_singular('sessions') || is_page('sessions') ) {
		
		wp_enqueue_style( 'wfn2017-page', get_template_directory_uri() . '/css/page.css' );
		
		wp_enqueue_style( 'wfn2017-sessions' , get_template_directory_uri() . '/css/sessions.css' );
		...
		//$file_name = '/wp-content/themes/wfn2017/css/sessions.css';
		
		if ( 'contact' == $post_type ) {
			
			wp_enqueue_style( 'wfn2017-' . esc_attr( $post_type ), $file_name );
	...
	wp_enqueue_script( 'wordfes2017-match-height',        get_template_directory_uri() . '/js/jquery.matchHeight-min.js', array(), null, true );
	wp_enqueue_script( 'wordfes2017-scripts',             get_template_directory_uri() . '/js/scripts.js', array(), null, true );
	wp_enqueue_script( 'wordfes2017-slider', get_template_directory_uri() . '/js/jquery.bxslider.min.js', array(jquery), null, true );
	wp_enqueue_script( 'wordfes2017-slider', get_template_directory_uri() . '/js/bxslider-test.js', array(jquery), null, true );
		

	wp_enqueue_script( 'wordfes2017-navigation', get_template_directory_uri() . '/js/navigation.js', array(), null, true );

	// bootstrap
	wp_enqueue_script( 'wordfes2017-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array( 'jquery' ), null, true );
...
add_action( 'wp_enqueue_scripts', 'wordfes2017_scripts' );
