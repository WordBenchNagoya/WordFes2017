...
class BxSliderWp_Crispin_RestClientWp extends BxSliderWp_Crispin_RestSigner implements BxSliderWp_Crispin_RestClientInterface{
	protected $publicId;
	protected $secretKey;
	protected $signedUrl;
	...
	/**
	 * BxSliderWp_Crispin_RestClientWp constructor.
	 *
