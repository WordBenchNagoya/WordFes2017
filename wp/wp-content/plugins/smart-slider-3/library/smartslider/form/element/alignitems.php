...
class N2ElementAlignItems extends N2ElementRadioTab {

    protected $class = 'n2-form-element-radio-tab n2-form-element-icon-radio';

    function generateOptions(&$xml) {
        $options = array(
            'stretch'    => 'n2-i n2-it n2-i-stretch',
            'flex-start' => 'n2-i n2-it n2-i-vertical-top',
            'center'     => 'n2-i n2-it n2-i-vertical-middle',
            'flex-end'   => 'n2-i n2-it n2-i-vertical-bottom'
        );
