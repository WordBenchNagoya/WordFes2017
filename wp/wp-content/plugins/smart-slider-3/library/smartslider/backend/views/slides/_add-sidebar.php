    ...
    <div class="n2-ss-add-sidebar-inner">
        <div class="n2-ss-addlayer">
            ...
            <div class="n2-ss-available-layers">
                ...
                ?>
                <?php
                foreach (N2SmartSliderItemsFactory::getItemGroups() AS $groupName => $group) {
                ...
                <div id="n2-ss-layers-switcher">
                    ...
                    nextend.ready(
                        function ($) {
                            new NextendHeadingPane($('#n2-ss-layers-switcher'), $('#n2-ss-layers-switcher > .n2-labels .n2-td'), $('#n2-ss-layers-switcher > .n2-tabs > div'));
                        }
                    );
                </script>
            </div>
