...
class n2lessc
{
    ...
    protected function makeParser($name) {
        $parser                = new n2lessc_parser($this, $name);
...
class n2lessc_parser
{
    ...
    public function __construct($lessc, $sourceName = null) {
        ...
        if (!self::$operatorString) {
            ...
            $commentSingle     = n2lessc::preg_quote(self::$commentSingle);
            $commentMultiLeft  = n2lessc::preg_quote(self::$commentMultiLeft);
            $commentMultiRight = n2lessc::preg_quote(self::$commentMultiRight);
    ...
    protected function literal($what, $eatWhitespace = null) {
        ...
        if (!isset(self::$literalCache[$what])) {
            self::$literalCache[$what] = n2lessc::preg_quote($what);
        }
