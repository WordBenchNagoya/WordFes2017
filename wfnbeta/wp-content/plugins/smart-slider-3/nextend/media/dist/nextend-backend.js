                ...
                links = {
                    ...
                    fn: {
                        show: function () {
                            ...
                            var external = $('<div class="n2-input-button"><input placeholder="External url" type="text" id="external-url" name="external-url" value="" /><a href="#" class="n2-button n2-button-big n2-button-green n2-uc n2-h4">Insert</a></div>')
                                .css({
                                    display: 'block',
                                    textAlign: 'center'
                                })
